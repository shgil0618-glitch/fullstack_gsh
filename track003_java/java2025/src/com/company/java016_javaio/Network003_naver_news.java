...
public class Network003_naver_news {
	public static void main(String[] args) {
		...
		// 1. URL
		try {
			String apiurl = "https://openapi.naver.com/v1/search/news.json?query="	//xml or json url뒤에 ?query=
					+ URLEncoder.encode("캄보디아","UTF-8");							//한글 깨지므로 UTF-8로 인코딩
...
https://openapi.naver.com/v1/search/news.xml - JSON
