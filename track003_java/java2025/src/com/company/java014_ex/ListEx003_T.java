...
class IceCreamDTO_T {
	...
	public IceCreamDTO_T() { super(); }
	public IceCreamDTO_T(String name, int price) 
...
public class ListEx003_T {
    public static void main(String[] args) {
    	//## 힌트2) List로   IceCreamDTO 자료형만 입력받을수 있는 동적배열 만들기
    	List<IceCreamDTO_T> list = new ArrayList<>();
        ...
        while(true) {
            ...
            switch(choice) {
            	case 1 :  //1. 추가 아이스트림 이름, 가격입력받아서 list에 추가 list.add(  아이스크림객체 )
            		...
            		scanner.nextLine();
            		list.add(new IceCreamDTO_T(name,price));
            	...
            	case 3 :  //3. 제거 아이스크림 이름입력받아서 제거   list.remove()
            		...
            		System.out.println("✅ "  + rname + " 🧹제거 완료!");
            	break;
