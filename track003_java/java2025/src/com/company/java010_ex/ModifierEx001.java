...
class Friend extends Modifier001_Friend {
...
public class ModifierEx001 {
	public static void main(String[] args) {
		System.out.println("자바의 접근자를 넓은범위에서 좁은범위로 적으시오.");
		System.out.println(" public(아무데서나) > protected(extends) > default(같은폴더내에서만) > private(클래스 안에서만) ");
