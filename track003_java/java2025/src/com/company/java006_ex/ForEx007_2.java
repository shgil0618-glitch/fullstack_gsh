...
public class ForEx007_2 {
	...
	int kor=0, mat=0, eng=0, total=0, i=1;
	...
	for(;;) {
		switch(i) {
		case 1:	System.out.print("국어점수 입력 : "); kor=scanner.nextInt();
				if(kor>=0 && kor<=100) {}
				else {i=1; continue;}
		case 2 :System.out.print("수학점수 입력 : "); mat=scanner.nextInt();
				if(mat>=0 && mat<=100) {}
				else {i=2; continue;}
		case 3 :System.out.print("영어점수 입력 : "); eng=scanner.nextInt();
