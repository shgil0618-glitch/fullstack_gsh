...
public class QuestController { 
   ...
   public String list(Model model,
         @RequestParam(value="pstartno", defaultValue="1") int pastartno
         ) { 
            model.addAttribute("list", service.select10(pastartno));   // 처리하고
            model.addAttribute("paging", new PagingDto(service.selectTotalCnt(), pastartno));
